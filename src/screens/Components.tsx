...
const Cards = () => {
  ...
  return (
    <Block marginTop={sizes.m} paddingHorizontal={sizes.padding}>
      ...
      {/* single card */}
      <Block justify="space-between"  card padding={0} marginTop={sizes.l} >
        <Block card >
    
          <Block padding={sizes.xxl} justify="space-between">
            <Text p semibold marginRight={sizes.xxl}   >Etage 1</Text>
            <TouchableOpacity>
        ...
        <Block card >
            ...
            <Block padding={sizes.xxl} justify="space-between">
              <Text p semibold marginRight={sizes.xxl}   >Etage 2</Text>
              <TouchableOpacity    onPress={() => navigation.navigate('ConsommationG')}>
                <Block row align="center">
                  <Text p semibold marginRight={sizes.s} color={colors.link}>
                    Details
                  </Text>
